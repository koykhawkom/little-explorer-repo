...
- **Wallet History**: Integrated recent transaction history directly into the Wallet screen.
- **Star Request**: Refined Star Request features and improved parent-child workflow.
